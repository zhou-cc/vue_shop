<template>
    ...
    <el-card>
      <!-- 提示区域 -->
      <el-alert
        title="添加商品信息" type="info" :closable="false" show-icon center></el-alert>
        ...
        <el-tabs :tab-position="'left'" v-model="activeIndex" :before-leave="beforeTabLeave" @tab-click="tabClicked">
            ...
            <el-tab-pane label="商品内容" name="4">
                ...
                <el-button type="primary" size="mini" class="btnAdd" @click="add">添加商品</el-button>
            </el-tab-pane>
            </el-tabs>
        </el-form>
        </el-card>
...
methods:{
    ...
    add(){
        ...
        this.manyTableData.forEach(item =>{
            const newInfo ={
            attr_id: attr_id,attr_value:item.attr_vals.join(' ')};
